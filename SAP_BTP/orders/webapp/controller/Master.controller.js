    sap.ui.define([
        ...
        function (Controller) {
            ...
            return Controller.extend("numen.t21.apps.orders.controller.Master", {
                /*Aqui na função onInit, o oRouter recebe a rota do componente pai da Aplicação, ou seja, permite o controller acessar
                a aplicação como um todo* para pegar a routa do que será criado na Master*/
                onInit: function () {
