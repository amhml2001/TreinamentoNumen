sap.ui.define([
	...
	return BaseController.extend("numen.talentos.ztlnt2021001amh.controller.Master", {
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "numen.talentos.ztlnt2021001amh.view.ViewSettingsDialog",
					controller: this
        ...
        onCreateCompany: function(oEvent){
            ...
            if(!this.oDialogEditCompany){
                this.oDialogEditCompany = Fragment.load({
                    id: this.getView().getId(),
                    name: "numen.talentos.ztlnt2021001amh.view.PopUp",
                    controller: this
                }).then(function (oDialog){
                    this.getView().addDependent(oDialog);
                    oDialog.addStyleClass(this.getOwnerComponent().getContentDensityClass());
