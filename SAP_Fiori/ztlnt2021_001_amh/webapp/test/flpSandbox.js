					...
					"config": {
						"inbounds": {
							"CompanhiasAéreas-display": {
								...
								"action": "display",
								"description": "Formação de Talentos - Teste de Fiori",
								"title": "Companhias Aéreas",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=numen.talentos.ztlnt2021001amh",
									"url": sap.ui.require.toUrl("numen/talentos/ztlnt2021001amh")
								}
							}
						}
					}
