...
function addRelatedFacetKeysType(schema, entityType, oDataServiceAVT, logger) {
    ...
    const facetSections = common_1.getObjectPageFacetSection(entityType, oDataServiceAVT, logger);
    if (facetSections) {
...
function generateObjectPageSchemaV2(genericSchema, entityTypeName, oDataServiceAVT, manifest, fragments, logger) {
    ...
    if (!entitySet) {
        v2_1.log(logger, {
            ...
            message: i18next_1.default.t('NOENTITYSET4TYPE', { entityType: entityTypeName }),
            location: {
