import { GenericColumns, TableTypeV2, PopinLayout, QuickVariantSelection, Fields4Dialog, QuickVariant, FieldPath } from './Table';
...
export interface Fields4DialogOP extends Fields4Dialog {
    fields: {
