...
class V2AppProvider extends appProvider_1.AppProvider {
    constructor(manifest, changes, schemas, fragments, logger) {
        ...
        // Call base
        super(manifest, schemas, generateId(v2Pages[Object.keys(v2Pages)[0]]), getPagesAndConfigs(v2Pages, changes, manifest, schemas, fragments, logger), common_1.FioriElementsVersion.v2, appSettings);
    }
}
