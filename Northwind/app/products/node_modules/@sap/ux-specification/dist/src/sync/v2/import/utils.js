 ...
 * @param {{ [key: string]: any }} configPart - Application or Page Config object.
 ...
 */
function transferSettingsOfObject(configPart, manifest, jsonSchema, pageKeys, sectionId) {
    let manifestSection = {};
    for (const propertyKey in jsonSchema['properties'] || jsonSchema) {
        ...
        if (syncRule && syncRule.manifest) {
            ...
            const path = syncRule.manifest.path(pageKeys, {}, sectionId);
